...
<table border="1">
    <tr>
        <td width="80"  rowspan="3" height="81" align="center" bgcolor="#CCCCCC"><b>
        Rangking</b></td>
    ...
    <tr>
        <td height="19" align="center" bgcolor="#CCCCCC"><b>1-1000</b></td>
        <td height="19" align="center" bgcolor="#CCCCCC"><b>1-100</b></td>
    </tr>

        @foreach($fix as $g)
                <tr>
                    <td align="center" height="19">{{$g['rangking']}}</td>
